...
export async function fetchAdminDashboardData(admin?: AdminDashboardData["admin"]): Promise<AdminDashboardData> {
  ...
  return {
    ...content,
    admin: admin ?? { id: 0, username: "admin", displayName: "Administrator" },
  };
}
